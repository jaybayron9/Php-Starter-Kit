        ...
        <div class="grid gap-4 xl:grid-cols-2 2xl:grid-cols-3">
            <div class="md:col-span-3 flex flex-col justify-center items-center px-6 mx-auto xl:px-0 dark:bg-gray-900">
                ...
                <div class="text-center xl:max-w-4xl">
                    <h1 class="mb-3 text-2xl font-bold leading-tight text-gray-900 sm:text-4xl lg:text-5xl dark:text-white">Welcome Developer</h1>
                </div>
            </div>
        </div>
    </div>
