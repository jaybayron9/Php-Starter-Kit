            ...
            <div class="flex-1 px-3 space-y-1 bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                <ul class="pb-2 space-y-2">
                    <li>
                        <a href="?vs=_sup" class="<?= urlIs('vs=_sup/') ? 'bg-sky-300' : '' ?> flex items-center p-2 text-base text-gray-900 hover:bg-gray-100 rounded-lg group font-semibold">
                            <svg class="w-6 h-6 <?= urlIs('vs=_sup/') ? 'text-gray-900' : 'text-gray-500' ?>   group-hover:text-gray-900" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="pt-2 space-y-2"> 
                    <a href="?vs=_sup/users" class="<?= urlIs('vs=_sup/users') ? 'bg-sky-300' : '' ?> flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg hover:bg-gray-100 group font-semibold">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6 <?= urlIs('vs=_sup/users') ? 'text-gray-900' : 'text-gray-500' ?>">
                ...
                <a href="?vs=_sup/inbox" class="<?= urlIs('vs=_sup/inbox') ? 'bg-sky-300' : '' ?> flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg hover:bg-gray-100 group font-semibold">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6  <?= urlIs('vs=_sup/inbox') ? 'text-gray-900' : 'text-gray-500' ?>">
