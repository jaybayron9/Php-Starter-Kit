...
<main id="main-content" class="relative h-full overflow-y-auto lg:ml-64 dark:bg-gray-900">
    <div class="px-4 h-full my-[80px]">
        <h1 class="mb-3 font-bold text-2xl">SUPPORTS</h1>
                ...
                <tbody>
                    <?php foreach ($conn::select('supports') as $support) { ?>
                        <tr>
                            ...
                            <td class="text-sm"><?= $support['phone'] ?></td>
                            <td class="text-sm"><?= $support['email'] ?></td>
                            <td class="text-sm"><?= date('M d, Y | h:i a', strtotime($support['created_at'])) ?></td>
                            <td class="text-sm text-center">
                                <button type="button" data-row-data="<?= $support['id'] ?>" class="delete text-red-500">
                                ...
                                <button type="button" data-row-data="<?= $support['id'] ?>" class="edit text-green-500">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
